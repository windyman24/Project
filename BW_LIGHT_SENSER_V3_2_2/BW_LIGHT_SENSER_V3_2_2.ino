...
void test()
{
  Serial.print(sensor.ReadSensor1_D());
  Serial.print(" ");
  Serial.print(sensor.ReadSensor1_A());
  Serial.print(" ");
  Serial.print(sensor.ReadSensor2_D());
  Serial.print(" ");
  Serial.print(sensor.ReadSensor2_A());
  Serial.print(" ");
  Serial.print(sensor.ReadSensor3_D());
  Serial.print(" ");
  Serial.println(sensor.ReadSensor3_A());
  Light_indication.work();
}
